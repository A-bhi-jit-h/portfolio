  ...
  const experiences = [
    {
      ...
      achievements: [
        'Successfully organized Python bootcamp for 50+ students',
        'Coordinated multiple technical workshops and seminars',
        'Enhanced student engagement in programming activities'
      ],
      icon: Award,
      current: true
    },
    {
      ...
      achievements: [
        'Moderate discussions for 200+ community members',
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8 mb-16">
            {experiences.map((exp, index) => (
              <Card 
                key={index} 
                className={`glass-card border-border hover:border-primary/30 transition-all duration-300 ${
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex items-start space-x-4">
                      <div className={`p-3 rounded-lg ${
                        exp.current ? 'bg-primary/20' : 'bg-primary/10'
                      }`}>
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-1">
                      {exp.achievements.map((achievement, achIndex) => (
                        <li key={achIndex} className="flex items-start space-x-2 text-muted-foreground text-sm">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-3">
                  {skills.map((skill, index) => (
                    <span
                      key={index}
                      className="px-3 py-2 text-sm bg-primary/10 text-primary rounded-lg border border-primary/20 text-center"
                    >
                      {skill}
                    </span>
                  ))}
